...
number = 20;
shoulder_vec = linspace(-1, 1, number);
base_vec = linspace(-0.55, 0.55, number);
knee_vec = linspace(-2, 2, number);
for i = 1 : number
...
%     wb_motor_set_position(Legs((1:3), 1), base_vec(i));
%     wb_motor_set_position(Legs((1:3), 3), knee_vec(i));
%     
%     
